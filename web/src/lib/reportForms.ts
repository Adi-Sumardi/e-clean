...
export const REPORT_SCHEMAS: Record<DomainKey, ReportSchema> = {
  kebersihan: {
    ...
    fields: [
      ...
      { name: "foto_sebelum", label: "Foto sebelum", kind: "photos", required: true, min: 1, max: 10 },
      { name: "foto_sesudah", label: "Foto sesudah", kind: "photos", required: true, min: 1, max: 10 },
  ...
  satpam: {
    ...
    fields: [
      ...
      { name: "foto", label: "Foto (opsional)", kind: "photos", max: 10 },
      { name: "catatan_petugas", label: "Catatan (opsional)", kind: "textarea", max: 1000 },
    ],
  },
  ob: {
    ...
    fields: [
      ...
      { name: "foto_sebelum", label: "Foto sebelum (opsional)", kind: "photos", max: 10 },
      { name: "foto_sesudah", label: "Foto sesudah (opsional)", kind: "photos", max: 10 },
      { name: "catatan_petugas", label: "Catatan (opsional)", kind: "textarea", max: 1000 },
    ],
  },
  toko: {
